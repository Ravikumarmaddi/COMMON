 ...
 */
public class Java7NewFeatursDemo {

	public static void main(String[] args) {
		new Java7NewFeatursDemo().testUnderscoresNumericLiterals();
	}
	...
	public void testMultiCatch() throws FileNotFoundException {
		...
		} catch (SQLDataException | IOException fnfo) {
			fnfo.printStackTrace();
		}
	}
